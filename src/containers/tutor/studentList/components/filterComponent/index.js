...
const TutorStudentFilterComponent = (props) => {


  const { visible, onClose, onSelect, offerings, clearSelection} = props;

  const [selectedOffering, setSelectedOffering] = useState({});
    console.log('Subjects are ', offerings);
  useEffect(() => {
...
TutorStudentFilterComponent.propTypes = {
...
export default TutorStudentFilterComponent;
