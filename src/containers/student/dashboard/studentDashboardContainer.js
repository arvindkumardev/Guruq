      ...
      <Container>
        ...
        <Footer>
          <FooterTab style={{ backgroundColor: Colors.white }}>
            ...
            <Button style={{ backgroundColor: Colors.white }} vertical active={activeTab === 2} onPress={() => changeTab(2)}>
            ...
            <Button style={{ backgroundColor: Colors.white }} vertical active={activeTab === 3} onPress={() => changeTab(3)}>
            ...
            <Button style={{ backgroundColor: Colors.white }} vertical active={activeTab === 4} onPress={() => changeTab(4)}>
            ...
            <Button style={{ backgroundColor: Colors.white }} vertical active={activeTab === 5} onPress={() => changeTab(5)}>
