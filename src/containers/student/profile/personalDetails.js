import { FlatList, TextInput, Image, SafeAreaView, StatusBar, Text, TouchableOpacity, View, Dimensions } from 'react-native';
import React, { useState } from 'react';
import { TouchableWithoutFeedback } from 'react-native-gesture-handler';
import { Container, Left, Right, Body, Title, Subtitle, Header, Content, Form, Item, Input, Label, Card } from 'native-base'
import commonStyles from '../../../theme/styles';
import { Colors, Images } from '../../../theme';
import { removeData, RfH, RfW } from '../../../utils/helpers';
import IconWrapper from '../../../components/IconWrapper';
import styles from './styles';
import { LOCAL_STORAGE_DATA_KEY, IND_COUNTRY_OBJ, STANDARD_SCREEN_SIZE } from '../../../utils/constants';
import { isLoggedIn, userDetails } from '../../../apollo/cache';
import DatePickerExample from './datePickerComponent';
import DateTimesPicker from './datePickerComponent';
    ...
    return (
        <Container>
            ...
            <Content>
                ...
                {
                    isEditDisable ? <TouchableOpacity
                    onPress={()=>_saveButton()}
                    style={{
                        height:RfH(45),
                        width:width/2.5,
