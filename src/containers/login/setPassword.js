            ...
            <KeyboardAvoidingView>
                <View style={{backgroundColor:Colors.white, paddingHorizontal:16, paddingVertical:56, borderTopLeftRadius:25, borderTopRightRadius:25}}>
                    <View style={{flexDirection:'column', justifyContent:'flex-start', alignItems:'stretch' }}>
                        <View>
                            <Item>
                                <Input secureTextEntry={hidePassword} placeholder="New Password"></Input>
                                <Icon type='Entypo' name={eyeIcon} onPress={() => onIconPress()} style={{fontSize:18, color:'#818181'}}></Icon>
                            </Item>
                        </View>
                        <View style={{marginTop:RfH(53.5)}}>
                            <Item>
                                <Input secureTextEntry={hideConfirmPassword} placeholder="Confirm Password"></Input>
                                <Icon type='Entypo' name={confirmEyeIcon} onPress={() => onConfirmIconPress()} style={{fontSize:18, color:'#818181'}}></Icon>
                            </Item>
                        </View>
                    </View>
