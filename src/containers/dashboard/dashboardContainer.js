      ...
      <Container>
        ...
        <Footer>
          <FooterTab style={{backgroundColor:Colors.white}}>
            <Button style={{backgroundColor:Colors.white}} vertical active={activeTab === 1} onPress={() => changeTab(1)}>
              <Thumbnail square style={{height:17, width:17.7}} source={(activeTab === 1)?Images.home_active:Images.home}/>
